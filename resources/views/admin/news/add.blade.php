...
@section('title') Add News - {{ config('app.name', 'Laravel') }} @endsection
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('news.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="subtitle" id="subtitle" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="text-left">
                                <button type="submit" class="btn btn-dark">Add News</button>
                            </div>
